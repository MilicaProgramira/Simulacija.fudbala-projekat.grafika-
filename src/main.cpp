...
struct ProgramState {
    glm::vec3 moveBall = glm::vec3(0.0f);
    glm::vec3 rotateDir =  glm::vec3(1.0f ,0.0f, 0.0f);
...
//    stbi_set_flip_vertically_on_load(true);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // lights settings
        //dirLight
        ourShader.setVec3("dirLight.direction", glm::vec3(0.5f, 1.0f, 0.5f));
        ...
        //Point light 1
        ourShader.setVec3("pointLights[0].position", glm::vec3(-2.85f, 0.5f, sin(currentFrame)*2.2f));
        ...
        //Point light 2
        ourShader.setVec3("pointLights[1].position", glm::vec3(2.85f, 0.5f, cos(currentFrame)*2.2f));
        ...
        modelBall = glm::translate(modelBall,glm::vec3(0.0f,0.02f,0.0f)+programState->moveBall);
        modelBall = glm::scale(modelBall, glm::vec3(0.1f));
        modelBall = glm::rotate(modelBall, glm::radians(programState->rotateAmount), programState->rotateDir);
...
void processInput(GLFWwindow *window) {
    ...
    if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS){
        programState->moveBall+=glm::vec3(0.03f, 0.0f, 0.0f);
        programState->rotateDir = glm::vec3(0.0f ,0.0f, -1.0f);
        programState->rotateAmount+=8.0f;
    }
    ...
    if (glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS){
        programState->moveBall+=glm::vec3(0.0f, 0.0f, -0.03f);
        programState->rotateDir = glm::vec3(-1.0f ,0.0f, 0.0f);
        programState->rotateAmount+=8.0f;
    }
...
void DrawImGui(ProgramState *programState) {
    ...
    {
        static float f = 0.0f;
        ImGui::Begin("FOOTBALL GAME!");
        ImGui::Text("Welcome to football game simulator :D");
        ImGui::End();
    }
